...
function LoginPage() {
  ...
  <div className="min-h-screen bg-gray-900 text-white flex flex-col md:flex-row">
    ...
    {/* Left: Login Form */}
    <div className="md:w-1/2 flex flex-col justify-center items-end p-8">
      <div className="w-full max-w-md ml-auto bg-gray-800 rounded-lg shadow-lg p-8">
        <motion.h2
...
>
  Welcome to <span className="text-indigo-400">Expetrack</span>
</motion.h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-indigo-500"
              required
            />
          </div>
